...
export class AddEmailToJobAdTable1755998097316 implements MigrationInterface {
    name = 'AddEmailToJobAdTable1755998097316'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_job_ads" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "is_external" boolean NOT NULL DEFAULT (0), "external_name" varchar(255) NOT NULL DEFAULT ('system'), "external_id" bigint NOT NULL, "metadata" text NOT NULL, "name" varchar(255) NOT NULL, "office" varchar(255) NOT NULL, "job_ad_action_id" integer NOT NULL DEFAULT (1), "email" varchar(255), CONSTRAINT "UQ_0c2e2cf79152a1ce1fb986fd983" UNIQUE ("external_id", "external_name"))`);
        await queryRunner.query(`INSERT INTO "temporary_job_ads"("id", "is_external", "external_name", "external_id", "metadata", "name", "office", "job_ad_action_id") SELECT "id", "is_external", "external_name", "external_id", "metadata", "name", "office", "job_ad_action_id" FROM "job_ads"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "job_ads"("id", "is_external", "external_name", "external_id", "metadata", "name", "office", "job_ad_action_id") SELECT "id", "is_external", "external_name", "external_id", "metadata", "name", "office", "job_ad_action_id" FROM "temporary_job_ads"`);
        await queryRunner.query(`DROP TABLE "temporary_job_ads"`);
    }
